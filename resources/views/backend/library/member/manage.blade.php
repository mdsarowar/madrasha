                            ...
                            @foreach($members as $member)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route('library_member.destroy', $member->id) }}" method="post" style="display: inline-block"  onsubmit="return confirm('Are You sure that to delete this Section'); ">
                                            @csrf
                                            @method('delete')
