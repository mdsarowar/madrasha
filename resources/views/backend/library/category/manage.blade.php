                            ...
                            @foreach($bookcategorys as $bookcategory)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route('library_book_category.destroy', $bookcategory->slug) }}" method="post" style="display: inline-block"  onsubmit="return confirm('Are You sure that to delete this Section'); ">
                                            @csrf
                                            @method('delete')
