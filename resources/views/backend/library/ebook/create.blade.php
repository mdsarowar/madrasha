...
{{--                                                @error('academic_class_id')<span class="text-danger f-s-12">{{$errors->first('academic_class_id')}}</span> @enderror--}}
                                        ...
                                        <div class="form-group row mt-2">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <br/>
                                                <label for="" class="mt-2"> <input type="radio" name="status" value="1" {{$errors->any()&& old('status')==1 ? ('checked'):(isset($ebook) && $ebook->status == 1 ?'checked':'')}} >Published</label>
                                                <label for=""class="mt-2"> <input type="radio"  name="status" value="0" {{$errors->any()&& old('status')==0 ? ('checked'):(isset($ebook) && $ebook->status == 0 ?'checked':'')}} >UnPublished</label>
