        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{ route('exam_grade.create') }}" class="btn btn-success float-end">
                            ...
                            @foreach($grade as $exam)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('exam_grade.edit', $exam->id) }}" class="btn btn-info btn-sm py-0 px-1"><i class="dripicons-document-edit"></i></a>
                                        <form action="{{ route('exam_grade.destroy', $exam->id) }}" method="post" style="display: inline-block"  onsubmit="return confirm('Are You sure that to delete this Section'); ">
                                            @csrf
                                            @method('delete')
