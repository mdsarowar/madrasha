                                ...
                                <div>
                                    <form action="{{isset($exam) ? route('exam.update',$exam->id) : route('exam.store') }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row mt-4">
                                            ...
                                            <div class="col-md-8">
                                                <label for="" class="mt-2"> <input type="radio" name="status" value="1"  {{$errors->any() && old('status')==1? 'checked' :( isset($exam) && $exam->status == 1 ?'checked':'')}} >Published</label>
                                                <label for=""class="mt-2"> <input type="radio"  name="status" value="0" {{$errors->any() && old('status')==0?'checked' :(isset($exam) && $exam->status == 0 ?'checked':'')}} >UnPublished</label>
