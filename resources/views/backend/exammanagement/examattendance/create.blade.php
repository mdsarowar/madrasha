                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <select name="exam_schedule_id" class="select1 form-control" data-toggle="select1"  data-placeholder="Choose ...">
                                                    ...
                                                    @foreach($schedules as $schedule)
                                                        <option value="{{ $schedule->id}}" {{$errors->any() && old('exam_schedule_id')==$schedule->id? ('selected'):(isset($ExamAttendance) && $ExamAttendance->hostel_id==$schedule->id? 'selected':'')}}> {{$schedule->start_time}}</option>
                                                    @endforeach
                                                </select>
