                        ...
                        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap w-100">
                            ...
                            @foreach($hostelmembers as $hostelmember)
                                <tr>
                                    ...
                                    <td>{{ $hostelmember->bostel_balance }}</td>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route('hostel_member.destroy', $hostelmember->id) }}" method="post" style="display: inline-block"  onsubmit="return confirm('Are You sure that to delete this Section'); ">
                                            @csrf
                                            @method('delete')
